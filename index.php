...
<div class=" for-mobile" >
    <div class="d-flex flex-column justify-content-center align-items-center p-3">
        <i class="fs-1 text-primary bi bi-facebook py-3"></i>
        <br>
        <br>
        <br>


        <div class="d-flex w-100 row justify-content-between align-items-center mb-5 ">
            <div class=" col-4">
                <img class=" border rounded w-100 fix" src="./images/1e66a2c2c2ac84ebd2c4eb2a18398e3c.jpg" alt="">
                <p class=" fs-2 text-center ">PE PE</p>
            </div>
            <div class=" col-4">
                <img class=" border rounded w-100 fix" src="./images/eab971592c8671e3d801d1b734202201.jpg" alt="">
                <p class=" fs-2 text-center ">PE PE</p>
            </div>
            <div class=" col-4">
                <img class=" border rounded w-100 fix" src="./images/0b5dfdb50664e912c8c8237a27aa3800.jpg" alt="">
                <p class=" fs-2 text-center ">PE PE</p>
            </div>
        </div>
        ...
        <div class="d-flex flex-column align-items-center ">
            <i class=" mb-4 text-primary fs-3 bi bi-gear-fill"></i>
            <a class=" fs-5 text-decoration-none mb-2" href="./login.php">Log into another account</a>
            <a class=" fs-5 text-decoration-none mb-2" href="./forget_ps.php">Sign up for Facebook</a>

            <button class="btn button btn-outline-primary border-0 bg-light w-100 fs-3 border rounded-3">
                <a href="./createnwacc.php" class=" text-decoration-none">Create new account</a>
            </button>
        </div>
                ...
                <div class=" d-flex align-items-center">
                    ...
                    <a id="card" class=" text-decoration-none text-dark position-relative" href="...">
                        <div class=" card me-2" style="width: 10rem;">
                            ...
                            <img src="./images/0b5dfdb50664e912c8c8237a27aa3800.jpg" class=" w-100 fixd card-img-top" alt="...">
                            <div class="card-body">
                                <p class="card-text text-center">Vixx Grego</p>
                            </div>
                        </div>
